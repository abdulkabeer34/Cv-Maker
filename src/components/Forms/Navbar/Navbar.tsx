      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-20">
        <div className="relative flex h-16 items-center justify-between">
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            {/* Mobile menu button*/}
            <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md p-2 bg-stone-500 hover:bg-stone-600 text-white  focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            {/* <div className="flex flex-shrink-0 items-center">
              <img
                // alt="Your Company"
                src="https://www.brandcrowd.com/maker/logo/elegant-company-firm-775962?isVariation=True"
                className="h-8 w-auto"
              />
              <h1 className='text-2xl'>Cv Maker</h1>
            </div> */}
                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={classNames(
                      item.current ? 'bg-stone-700 text-white' : 'text-black hover:bg-stone-400 hover:text-white',
